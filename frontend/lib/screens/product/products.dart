...
import 'package:stock_landy/screens/product/create.dart';
import 'package:stock_landy/screens/product/update.dart';
...
class _ShowProductsState extends State<ShowProducts> {
    ...
    Future<void> _performProductDeletion(Product product) async {
      ...
      if (e.response!.statusCode == 401) {
        ...
        showToast(context, "Erreur lors de la suppression du produit. Veuillez réessayer.");
      }
      }
    }
