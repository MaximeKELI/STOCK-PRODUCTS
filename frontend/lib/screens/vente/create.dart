...
import 'package:stock_landy/dialogs/stock_movement/quantity.dart';
...
import 'package:stock_landy/screens/history.dart';
import 'package:stock_landy/services/product.dart';
import 'package:stock_landy/services/stock_movement.dart';
...
class _CreateSellState extends State<CreateSell> {
  ...
  create(data) async {
    ...
    try {
      ...
      print(data);
      print(response);
      showToast(context, "Vente enregistré avec succès");
      noteController.text = "";
