  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Center(
              child: Text(
                "Stock Landy est une application de gestion de stock qui vous permet de gérer facilement vos produits, vos fournisseurs, vos commandes et vos mouvements de stock.",
                style: TextStyle(
                  fontSize: 16,
                ),
              ),
      ...
      bottomNavigationBar: const CustomBottomNavigationBar(
          index:
              0), // Remplacez 2 par l'index de l'onglet "À propos" dans votre BottomNavigationBar
    );
  }
}
