...
import 'package:stock_landy/models/order.dart';
import 'package:stock_landy/models/product.dart';
import 'package:stock_landy/screens/order/create.dart';
import 'package:stock_landy/screens/order/detail.dart';
import 'package:stock_landy/screens/order/update.dart';
import 'package:stock_landy/services/order.dart';
...
class _ShowOrdersState extends State<ShowOrders> {
  ...
  _loadOrders() async {
    try {
      ...
      showToast(context, "Erreur lors du chargement des commandes. Veuillez réessayer.");
    } finally {
        setState(() {
          isLoding = false;
      });
  ...
  Future<void> _deleteOrder(Order order) async {
    try {
      ...
      showToast(context, "Commande supprimée avec succès");
